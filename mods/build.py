...
def init_build(colors_mod, load_repo_una_func, StepRunner_class, 
             get_target_triple_func, get_arch_flags_func,
             propagate_skel_func, sync_kernel_config_func,
             is_repo_dirty_func, BASE_DIR_val, bld_base_val,
             arches_val, repos_val, repos_to_process_val,
             required_names_val, build_all_val, tools_install_dir_val,
             skel_dir_val, global_cfg_val):
